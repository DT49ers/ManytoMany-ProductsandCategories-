    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Product(int productId)
        {
            ...
            ViewBag.UnrelatedCategories = db.Categories
                .Include(cat => cat.ProductsCategories)
                .Where(cat => cat.ProductsCategories.Any(catProd => catProd.ProductId == prod.ProductId) == false).ToList();

            return View("Product");
        }

        [HttpPost("products/{productId}/relate")]
        public IActionResult RelateCategoryToProduct(int productId, ProductCategory newCatProd)
        {
            ...
            db.ProductCategories.Add(newCatProd);
            db.SaveChanges();
        ...
        public IActionResult Category(int categoryId)
        {
            ...
            List<Product> unrelatedProduct = db.Products
                ...
                .Where(prod => prod.ProductCategories.Any(catProd => catProd.CategoryId == cat.CategoryId) == false).ToList();
        ...
        public IActionResult RelateProductToCategory(int categoryId, CategoryPage categoryPage)
        {
            ...
            categoryPage.NewRelationship.CategoryId = categoryId;
            db.ProductCategories.Add(categoryPage.NewRelationship);
            db.SaveChanges();
